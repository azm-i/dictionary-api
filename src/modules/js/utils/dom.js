...
const cacheLoadImage = (window.sdCacheLoadImage = window.sdCacheLoadImage || {})
 ...
 * @returns {number}
 */
export function getVariableSize(size) {
...
export function getVariableSizeTb(size) {
  return (
...
export function getVariableSizeTbPortrait(size) {
  return (
    (size * getSafeWindowWidth()) /
    (media.isSp
      ? store.designWidthSp
 ...
 * @returns {number}
 */
export function getVariableSizeHeight(size) {
  return (
 ...
 * @returns {string}
 */
export function getVariableSizeRem(size) {
  return `${size / 16}rem`
}
