...
import { easeAllList } from '~/utils/gsap'
...
class DatGUI {
  ...
  constructor() {
    ...
    this.gui.closed = !process.env.isOpenDatGui || media.isSp

    if (process.env.isShowDatGui) {
...
const datGUI = (window.sdDatGUI = window.sdDatGUI || new DatGUI())
